...
var $author$project$Types$Message = F2(
...
var $author$project$Decoders$roleDecoder = function (str) {
	switch (str) {
		case 'system':
			return $elm$json$Json$Decode$succeed($author$project$Types$System);
		case 'user':
			return $elm$json$Json$Decode$succeed($author$project$Types$User);
		case 'assistant':
			return $elm$json$Json$Decode$succeed($author$project$Types$Assistant);
		default:
			return $elm$json$Json$Decode$fail('Invalid role: ' + str);
	}
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Decoders$decodeRole = A2($elm$json$Json$Decode$andThen, $author$project$Decoders$roleDecoder, $elm$json$Json$Decode$string);
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Decoders$decodeMessage = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Types$Message,
	A2($elm$json$Json$Decode$field, 'role', $author$project$Decoders$decodeRole),
	A2($elm$json$Json$Decode$field, 'content', $elm$json$Json$Decode$string));
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$map7 = _Json_map7;
var $author$project$Decoders$decodeApiResponsePocketbase = A8(
	$elm$json$Json$Decode$map7,
	$author$project$Types$ApiResponsePocketbase,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'collectionId', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'collectionName', $elm$json$Json$Decode$string),
...
var $author$project$Home$bookmarkChat = function (conversation) {
	...
	var _v0 = A2($elm$core$Debug$log, 'Request Body', requestBodyJsonString);
	return $elm$http$Http$request(
		{
			body: $elm$http$Http$jsonBody(requestBody),
			expect: A2($elm$http$Http$expectJson, $author$project$Types$GotResponseFromPocketbase, $author$project$Decoders$decodeApiResponsePocketbase),
			headers: _List_Nil,
			method: 'POST',
...
var $author$project$Home$chatMessages = F2(
	function (question, model) {
		return A3(
			$author$project$Types$ChatCompletion,
			'gpt-3.5-turbo',
			_Utils_ap(
				A2(
					$elm$core$List$map,
				...
				_List_fromArray(
					[
						A2($author$project$Types$Message, $author$project$Types$User, question)
					])),
			0.7);
	});
var $author$project$Types$ApiResponse = function (choices) {
...
var $author$project$Decoders$decodeChoice = A4(
	...
	A2($elm$json$Json$Decode$field, 'message', $author$project$Decoders$decodeMessage),
	A2($elm$json$Json$Decode$field, 'finish_reason', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'index', $elm$json$Json$Decode$int));
var $author$project$Decoders$decodeApiResponse = A2(
	$elm$json$Json$Decode$map,
	$author$project$Types$ApiResponse,
	A2(
		$elm$json$Json$Decode$field,
		'choices',
		$elm$json$Json$Decode$list($author$project$Decoders$decodeChoice)));
var $elm$json$Json$Encode$float = _Json_wrap;
var $author$project$Encoders$encodeChatCompletion = function (chatCompletion) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'model',
				$elm$json$Json$Encode$string(chatCompletion.model)),
				_Utils_Tuple2(
				'messages',
				A2($elm$json$Json$Encode$list, $author$project$Encoders$encodeMessage, chatCompletion.messages)),
				_Utils_Tuple2(
				'temperature',
				$elm$json$Json$Encode$float(chatCompletion.temperature))
			]));
};
...
var $author$project$Home$url = 'https://api.openai.com/v1/chat/completions';
var $author$project$Home$chatWithAi = F2(
	function (input, model) {
		var requestBody = $author$project$Encoders$encodeChatCompletion(
			A2($author$project$Home$chatMessages, input, model));
		var requestBodyJsonString = A2($elm$json$Json$Encode$encode, 2, requestBody);
		var _v0 = A2($elm$core$Debug$log, 'Request Body', requestBodyJsonString);
		return $elm$http$Http$request(
			{
...
var $author$project$Home$viewSuggestedQuestions = function (model) {
	...
	var userMessages = A2(
		$elm$core$List$filter,
		function (message) {
			return _Utils_eq(message.role, $author$project$Types$User);
		},
		allMessages);
	var matchedMessages = A2(
		$elm$core$List$filter,
		function (message) {
			return A2($elm$core$String$contains, model.inputText, message.content);
		},
		userMessages);
	var allContent = A2(
		$elm$core$List$map,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$id('aiSearch')
					]),
				A2(
					$elm$core$List$map,
					function (content) {
					...
					allContent)) : $rtfeldman$elm_css$Html$Styled$text('')
			]));
};
					...
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$rtfeldman$elm_css$Html$Styled$text('GO!')
											]))
									]))
							])),
						$author$project$Home$viewSuggestedQuestions(model),
						A4(
						$rtfeldman$elm_css$Html$Styled$styled,
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										($elm$core$List$length(model.choices) > 0) ? $rtfeldman$elm_css$Html$Styled$text('AI Chat') : $rtfeldman$elm_css$Html$Styled$text('')
									])),
								A2(
								$rtfeldman$elm_css$Html$Styled$div,
								_List_Nil,
...
var $author$project$Main$viewPage = F2(
	function (page, model) {
		switch (page.$) {
			case 'HomePage':
				return $author$project$Home$view(model);
			case 'DocsPage':
				return $author$project$Docs$view(model);
			default:
				var slug = page.a;
				return A2($author$project$Docs$viewDetail, slug, model);
		}
	});
	...
	return {
		body: _List_fromArray(
			[
				...
				A2($author$project$Main$viewPage, model.page, model))
			]),
		title: 'Elmgpt'
	};
};
